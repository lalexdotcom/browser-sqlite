...
<execution_context>
@/workspaces/wsqlite/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/workspaces/wsqlite/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
