...
Reference full template: `/workspaces/wsqlite/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/workspaces/wsqlite/.claude/get-shit-done/templates/state.md`.
