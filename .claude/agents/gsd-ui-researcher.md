...
Use template from `/workspaces/wsqlite/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/workspaces/wsqlite/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/workspaces/wsqlite/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
