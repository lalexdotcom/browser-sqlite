...
<execution_context>
@/workspaces/wsqlite/.claude/get-shit-done/workflows/new-workspace.md
@/workspaces/wsqlite/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @/workspaces/wsqlite/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
