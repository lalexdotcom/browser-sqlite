...
- [x] **BUG-01**: The `allQueryPragmas` condition is inverted — pragmas must be applied when the pragmas object is non-empty
...
- [x] **DOC-04**: Inline comments on `WorkerOrchestrator` and worker lifecycle state machine
