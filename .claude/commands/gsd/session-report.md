...
<execution_context>
@/workspaces/wsqlite/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/workspaces/wsqlite/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
